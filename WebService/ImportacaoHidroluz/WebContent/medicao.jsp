...
<%
	try {
		if (request.getSession().getAttribute("EMAIL_USU") != null
				&& request.getSession().getAttribute("ENDERECO") == null) {
			String ende = " ";
			request.getSession().setAttribute("ENDERECO", ende);
		} else if (request.getSession().getAttribute("EMAIL_USU") == null
				&& request.getSession().getAttribute("ENDERECO") != null) {
			String email = " ";
		...
		if (request.getSession().getAttribute("EMAIL_USU") == null
			...
			request.setAttribute("msg",
					"Sua sessÃ£o foi encerrada devido tempo de conexÃ£o inativo, favor realizar login novamente.");
			request.getRequestDispatcher("inicio.jsp").forward(request, response);
		}

	} catch (Exception ex) {
		request.setAttribute(ex.getMessage(), "Acesso fora da sessÃ£o ...");
		request.getRequestDispatcher("inicio.jsp").forward(request, response);
	}
%>
<!doctype html>
		...
		<div class="col-md-12"
			...
			<div class="row">
				...
				<div class="col-md-6" style="text-align: left;">
					...
					<b>CondomÃ­nio: </b>${cond}<br> <b>Unidade: </b>${unidade}<br>
					<b>Bloco: </b>${bloco}
